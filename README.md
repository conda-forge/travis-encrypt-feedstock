About travis-encrypt-feedstock
==============================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/travis-encrypt-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=2093&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/travis-encrypt-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `travis-encrypt` can be installed with `conda`:
...
```
mamba install travis-encrypt
```

It is possible to list all of the versions of `travis-encrypt` available on your platform with `conda`:
...
```
mamba search travis-encrypt --channel conda-forge
```
...
mamba repoquery search travis-encrypt --channel conda-forge

# List packages depending on `travis-encrypt`:
mamba repoquery whoneeds travis-encrypt --channel conda-forge

# List dependencies of `travis-encrypt`:
mamba repoquery depends travis-encrypt --channel conda-forge
```
